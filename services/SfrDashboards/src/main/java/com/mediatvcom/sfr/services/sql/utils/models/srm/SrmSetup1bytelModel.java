 ...
 */
@Getter
public class SrmSetup1bytelModel implements LogModel, Serializable {

    private final StructType schema;
    private final String modelName = "bytel_setup_1";
    private final String logComponent = "srm";

    private final String rootCsv;

    public SrmSetup1bytelModel(String rootCsv) {
        schema = buildschema();
